...
getTELLmeHub <- function(read_online=TRUE, 
  ...
  init<-function(){
    tryCatch({
      ...
      message_inc("----- clean any missing style title on the hub")
  ...
  api_clean_missing_style_title<-function(){
    s=sprintf(paste0(TELLMEHUB_URL,"tellme/cleanMissingStyleTitle"))
    res<-admin.GET(s)
    # res$content
    return(res)
  }
